			...
			<div className={styles.ourCafeWrapper}>
				<div className={styles.ourCafeContent}>
					<div className={styles.aboutCafe}>
						<Typography variant="h2">our cafe</Typography>
						<Typography variant="body1">
							We are located in one of the most picturesque places in the city - on the banks of the river, this is your
							oasis within the city, where you can escape from the noisy and dusty metropolis. We really, really thought
							out everything to the smallest detail: a project built from a wild Transcarpathian log house, a fireplace
							in the main hall of the restaurant and panoramic windows overlooking the river, cozy conversations on the
							river bank and the best view terrace, a tent with a seating for 200 people, a fabulous children's house
							and swimming pool.
						</Typography>
